...
DarkPoolService::DarkPoolService(OrderProviderPtr order_provider, int concurrency) : order_provider(order_provider), concurrency(concurrency) {
...
bool DarkPoolService::is_concurrent() {
